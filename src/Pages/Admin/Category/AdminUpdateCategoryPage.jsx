...
import { updateCategory, getCategory } from "../../../Redux/ActionCreators/CategoryActionCreators"
            ...
            <div className="container-fluid" >
                <div className="row" >
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light text-center'> Update Category
