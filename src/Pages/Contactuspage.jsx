        ...
        <div className="container-fluid contact py-5">
            <div className="container py-5">
                <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: "800px"}}>
                    ...
                    <p className="mb-0">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <Link className="text-primary fw-bold" to="https://htmlcodex.com/contact-form">Download Now</Link>.</p>
                </div>
                <div className="row g-5">
                    ...
                    <div className="col-12 col-xl-1 wow fadeInUp" data-wow-delay="0.3s">
                        <div className="d-flex flex-xl-column align-items-center justify-content-center">
                            <Link className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" to=""><i className="fab fa-facebook-f"></i></Link>
                            <Link className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" to=""><i className="fab fa-twitter"></i></Link>
                            <Link className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-4 me-4 me-xl-0" to=""><i className="fab fa-instagram"></i></Link>
                            <Link className="btn btn-xl-square btn-light rounded-circle mb-0 mb-xl-0 me-0 me-xl-0" to=""><i className="fab fa-linkedin-in"></i></Link>
                        </div>
                    </div>
